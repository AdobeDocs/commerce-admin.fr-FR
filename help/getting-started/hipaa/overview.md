...
|----------------|-----------|-------|
| 2.4.7-p4 et versions ultérieures -p | 1.2.0 | La prise en charge d’ 2.4.7-p4 nécessite un [correctif](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27147) |
