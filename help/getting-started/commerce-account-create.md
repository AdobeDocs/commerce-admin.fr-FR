...
Si vous devez [envoyer votre premier ticket d’assistance](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#support-case) ou gérer votre relation Adobe Commerce en dehors d’un storefront spécifique, commencez par créer votre compte [!DNL Commerce] ou y accéder.
