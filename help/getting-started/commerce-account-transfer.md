...
>[!NOTE]
>
>Comme Adobe Commerce continue à s’intégrer avec d’autres solutions Adobe, un compte Adobe Commerce (MAGEID) nécessite désormais une association avec un Adobe ID. Adobe ID utilise la même adresse e-mail que celle associée à votre compte [Adobe Commerce](/help/getting-started/commerce-account-create.md#create-a-commerce-account).
...
>- Le propriétaire actuel n&#39;a pas d&#39;Adobe ID ou a un Adobe ID qui n&#39;est pas connecté à son compte [Adobe Commerce (MAGEID)](/help/getting-started/commerce-account-create.md#create-a-commerce-account).
...
>
>- Le propriétaire actuel fait toujours partie de l&#39;entreprise.
>- Le propriétaire actuel possède un Adobe ID connecté à son compte [Adobe Commerce (MAGEID)](/help/getting-started/commerce-account-create.md#create-a-commerce-account).
