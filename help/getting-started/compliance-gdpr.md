...
- Pour les diagrammes de flux de données et le mappage d&#39;entités de base de données, consultez la [Référence des informations personnelles](https://experienceleague.adobe.com/fr/docs/commerce-operations/security-and-compliance/reference/data-m2){: target="_blank"}.
