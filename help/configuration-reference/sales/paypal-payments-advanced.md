...
description: Vérifiez les paramètres de configuration dans la section [!UICONTROL PayPal Payments Advanced] de la page [!UICONTROL Sales] &gt; [!UICONTROL Payment Methods] de l’administrateur Commerce.
