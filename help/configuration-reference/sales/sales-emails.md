...
![Commentaires sur les factures](./assets/sales-emails-invoice-comments.png)<!-- zoom -->
...
![Commentaires d’expédition](./assets/sales-emails-shipment-comments.png)<!-- zoom -->
...
![Crédit](./assets/sales-emails-credit-memo.png)<!-- zoom -->
...
![Commentaires sur les notes de crédit](./assets/sales-emails-credit-memo-comments.png)<!-- zoom -->
...
![Commande prête à être récupérée en magasin](./assets/sales-emails-ready-pickup.png)<!-- zoom -->
...
![Approbation de commande](./assets/sales-emails-purchase-order-approval.png)<!-- zoom -->
...
| [!UICONTROL RMA Email Sender] | Affichage en magasin | Identifie la variable [contact de magasin](../../getting-started/store-details.md#store-email-addresses) qui apparaît comme l’expéditeur du message. Valeur par défaut : `Sales Representative` |
| [!UICONTROL RMA Email Template] | Affichage en magasin | Détermine la variable [modèle de courrier électronique](../../systems/email-templates.md) qui est utilisé pour la notification envoyée lorsqu’une RAM est générée pour un client. Modèle par défaut : `New RMA` |
...
| [!UICONTROL RMA Authorization Email Sender] | Affichage en magasin | Identifie la variable [contact de magasin](../../getting-started/store-details.md#store-email-addresses) qui apparaît comme expéditeur du message. Valeur par défaut : `Sales Representative` |
| [!UICONTROL RMA Authorization Email Template] | Affichage en magasin | Détermine la variable [modèle de courrier électronique](../../systems/email-templates.md) utilisé lors de l’envoi d’une notification d’autorisation RMA. Modèle par défaut : `RMA Authorization` |
...
![Commentaires de l’administrateur de la RMA](./assets/sales-emails-rma-admin-comments.png)<!-- zoom -->
...
| [!UICONTROL RMA Comment Email Sender] | Affichage en magasin | Identifie la variable [contact de magasin](../../getting-started/store-details.md#store-email-addresses) qui apparaît comme expéditeur du message. Valeur par défaut : `Sales Representative` |
| [!UICONTROL RMA Comment Email Template] | Affichage en magasin | Détermine la variable [modèle de courrier électronique](../../systems/email-templates.md) utilisé lorsqu’un administrateur ajoute un commentaire à une RMA pour un client. Modèle par défaut : `RMA Admin Comments` |
...
![Commentaires des clients RMA](./assets/sales-emails-rma-customer-comments.png)<!-- zoom -->
...
| [!UICONTROL RMA Comment Email Sender] | Affichage en magasin | Identifie la variable [contact de magasin](../../getting-started/store-details.md#store-email-addresses) qui apparaît comme expéditeur du message. Valeur par défaut : `Customer Support` |
...
| [!UICONTROL RMA Comment Email Template] | Affichage en magasin | Détermine la variable [modèle de courrier électronique](../../systems/email-templates.md) qui est utilisé lorsqu’un client ajoute un commentaire à une RAM. Modèle par défaut : `RMA Admin Comments` |
| [!UICONTROL Send RMA Comment Email Copy To] | Affichage en magasin | Fournit l’adresse électronique de toute personne à qui envoyer une copie de la notification. Séparez plusieurs adresses par une virgule. |
| [!UICONTROL Send RMA Comments Email Copy Method] | Affichage en magasin | Indique la méthode de courrier électronique utilisée pour envoyer la copie. Les options incluent : <br/>**`Bcc`**- Envoie une copie de courtoisie aveugle en incluant le destinataire dans l’en-tête du même email qui est envoyé au client. Le destinataire Cci n&#39;est pas visible par le client.<br/>**`Separate Email`** - Envoie la copie en tant que courrier électronique distinct. |
