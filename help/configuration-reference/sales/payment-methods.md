...
- [PayPal Payflow Pro](paypal-payflow-pro.md) (Inclut le passage en caisse express)
- [Lien de flux de production PayPal](paypal-payflow-link.md) (Inclut le passage en caisse express)
...
![Vérifier / Commande monétaire](./assets/payment-methods-check-money-order.png)<!-- zoom -->
...
| [!UICONTROL New Order Status] | Site Web | Détermine la valeur initiale [état de la commande](../../stores-purchase/order-status.md) affecté aux commandes payées par un chèque ou un mandat. Valeur par défaut : `Pending` |
...
![Paiement de transfert bancaire](./assets/payment-methods-bank-transfer-payment.png)<!-- zoom -->
...
>[!NOTE]
>
>Le paiement sur le compte n’est pas pris en charge pour les commandes avec [plusieurs adresses d’expédition](../../stores-purchase/shipping-settings.md#multiple-addresses) et n’apparaît pas parmi les options de paiement.
...
![Achat de sous-total nul](./assets/payment-methods-zero-subtotal-checkout.png)<!-- zoom -->
...
>[!NOTE]
>
>Ne sélectionnez pas le paramètre _[!UICONTROL Not Capture]_à moins que vous ne soyez certain que vous allez capturer le paiement par l’intermédiaire de Commerce ultérieurement. Vous ne pouvez pas créer d’avoir tant que le paiement n’a pas été capturé à l’aide du bouton Capturer .
...
| [!UICONTROL Title] | Affichage en magasin | Nom de ce mode de paiement qui s’affiche pour les clients lors de leur passage en caisse. |
| [!UICONTROL New Order Status] | Site Web | Détermine la valeur initiale [état de la commande](../../stores-purchase/order-status.md) affectée aux commandes payées par le bon de commande. Valeur par défaut : En attente |
