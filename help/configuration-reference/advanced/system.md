...
Pour plus d’informations sur la modification de ce paramètre, voir [Configuration de la devise](../../stores-purchase/currency-configuration.md) dans le _Guide des magasins et de l’expérience d’achat_.
...
| Champ | [Portée](../../getting-started/websites-stores-views.md#scope-settings) | Description |
|--- |--- |--- |
| [!UICONTROL Max Session Size in Admin] | Global | Limitez la taille de session maximale en octets. Utilisez `0` pour désactiver . |
| [!UICONTROL Max Session Size in Storefront] | Global | Limitez la taille de session maximale en octets. Utilisez `0` pour désactiver . |
...
Pour plus d’informations sur la modification de ces paramètres, voir [Mise en cache de page complète](../../systems/cache-management.md#full-page-caching) dans le _Guide des systèmes d’administration_.
...
| [!UICONTROL Grace period] | Global | Détermine la durée pendant laquelle Varnish diffuse du contenu obsolète si le serveur principal n’est pas réactif. Valeur par défaut : `300` |
...
![ Configuration avancée - Actions en masse](./assets/system-bulk-actions.png)<!-- zoom -->

Pour plus d’informations sur la modification de ces paramètres, voir [Actions en masse](../../systems/action-log-bulk-actions.md) dans le _Guide des systèmes d’administration_.

| Champ | [Portée](../../getting-started/websites-stores-views.md#scope-settings) | Description |
|--- |--- |--- |
| [!UICONTROL Days Saved in Log] | Global | Détermine le nombre de jours pendant lesquels les actions en bloc sont conservées dans l’archive _Bulk Actions Log_. Valeur par défaut : `60` |
