...
description: Vérifiez les paramètres de configuration sur la page [!UICONTROL Persistent Shopping Cart] de [!UICONTROL Customers] &gt ; de l’administrateur Commerce.
