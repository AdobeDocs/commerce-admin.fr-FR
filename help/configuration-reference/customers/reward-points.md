...
| Champ | [Portée](../../getting-started/websites-stores-views.md#scope-settings) | Description |
|--- |--- |--- |
| [!UICONTROL Purchase] | Site Web | Détermine si un message s’affiche dans le panier, indiquant les points de récompense gagnés pour l’achat et le solde du point de récompense actuel du client. Options : `Yes` / `No` |
