...
| [!UICONTROL Order Total] | Définit les valeurs min., max. ou les deux pour filtrer par total d’ordre. |

## Afficher une commande

Un client trouve l’ordre dans la liste et clique sur **[!UICONTROL View Order]**. Dans l’ordre d’ouverture, il peut effectuer l’une des opérations suivantes :
...
1. Dans l’onglet **[!UICONTROL Invoices]** , le client clique sur l’une des options suivantes :
...
1. Dans l’onglet **[!UICONTROL Order Shipments]** , le client clique sur l’une des options suivantes :
...
1. Dans l’onglet **[!UICONTROL Order Shipments]** , cliquez sur **[!UICONTROL Track this Shipment]**.
...
1. Sur l&#39;onglet **Remboursements**, le client clique sur l&#39;une des options suivantes :
...
Les commandes sont disponibles pour les clients lorsque l’option de configuration [_Autoriser la commande_](reorders-allow.md) est activée.
...
Annuler est disponible pour les clients et clientes lorsque l’option de configuration [_Autoriser l’annulation_](cancel-allow.md) est activée.
...
1. Fournit un motif d’annulation
   ...
   ![Annuler les motifs de la commande](./assets/cancel-order-reasons.png){width="700" zoomable="yes"}

   Vous pouvez personnaliser les raisons d’annulation sur la page [_Autoriser l’annulation_](cancel-allow.md).
...
1. Clics **[!UICONTROL Confirm]**
   ...
   ![Annuler l’e-mail de commande](./assets/cancel-order-email.png){width="700" zoomable="yes"}
   ...
   ![Message d’erreur d’annulation de commande](./assets/cancel-order-error-message.png){width="700" zoomable="yes"}

   Après actualisation de la page, vous pouvez constater que la commande était déjà terminée. C’est pourquoi l’annulation n’a pas fonctionné.
