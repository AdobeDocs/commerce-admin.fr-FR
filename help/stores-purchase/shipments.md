...
La variable _[!UICONTROL Shipments]_grid répertorie l’enregistrement de l’expédition de toutes les factures qui ont été préparées pour l’expédition. Un enregistrement d’expédition peut être généré lorsqu’une commande est [facturée](invoices.md) ou plus tard.

Adobe Commerce et Magento Open Source prennent en charge le transfert de commande partiel et complet, avec des options supplémentaires disponibles depuis [Inventory management](../inventory-management/introduction.md) et des extensions tierces.
...
Pour chaque élément de ligne dans l’ordre, modifiez la variable **[!UICONTROL Qty to Ship]** selon les besoins.
...
1. Dans le **[!UICONTROL Action]** pour l’ordre sélectionné, cliquez sur **[!UICONTROL View]**.

1. Cliquez sur **[!UICONTROL Ship]**.

1. Faites défiler l’écran vers le bas jusqu’à _[!UICONTROL Payment & Shipping Method]_bloquer et cliquer **[!UICONTROL Add Tracking Number]**.
...
1. Pour suivre l’envoi, saisissez la variable **[!UICONTROL Title]** et **[!UICONTROL Number]** .
...
1. Faites défiler l’écran vers le bas jusqu’à _[!UICONTROL Payment & Shipping Method]_bloque.

1. Sélectionnez la variable **[!UICONTROL Carrier]**.

1. Saisissez un **[!UICONTROL Title]** pour le module.

1. Entrer le tracking **[!UICONTROL Number]**.

1. Cliquez sur **[!UICONTROL Add]**.

1. Pour envoyer un email contenant des informations de tracking au client, cliquez sur **[!UICONTROL Send Tracking Information]**, puis confirmez l’action.

   Pour suivre l’emplacement d’une expédition, ouvrez-la en mode d’édition, puis cliquez sur **[!UICONTROL Track this shipment]**.

   ![Informations sur l’expédition et le suivi](./assets/tracking-information.png){width="600" zoomable="yes"}
...
1. Entrée **Commentaires** pour l’expédition, si nécessaire.

1. Une fois l’envoi prêt, cliquez sur **Envoyer l’envoi**.
...
1. Développez l’objet **Commentaires d’expédition** et modifiez les paramètres suivant les besoins :
   ...
   - La variable **[!UICONTROL Enabled]** est définie sur `Yes` par défaut, ce qui signifie que l’email est envoyé à un client lorsqu’un commentaire d’expédition est saisi.

   - Pour **[!UICONTROL Shipment Comment Email Sender]**, sélectionnez la personne à partir de laquelle l’e-mail de commentaire de l’envoi est envoyé. La valeur par défaut propose cinq adresses électroniques.
   ...
   - Pour **[!UICONTROL Shipment Comment Email Copy To]**, saisissez les adresses électroniques permettant d’envoyer une copie électronique de commentaire d’expédition. Séparez plusieurs adresses électroniques par une virgule.

   - Pour **[!UICONTROL Shipment Comment Email Copy Method]**, sélectionnez `bcc` (copie carbone aveugle) ou `separate email copy` selon vos préférences.
...
1. Dans le _Action_ colonne, choisissez **[!UICONTROL View]**.

1. Dans le panneau de gauche, choisissez **[!UICONTROL Shipments]**.

   Si l&#39;envoi peut être annulé, _[!UICONTROL Cancel Shipment]_apparaît comme option dans la barre de boutons supérieure.

1. Cliquez sur **[!UICONTROL Cancel Shipment]**.

1. Lorsque vous y êtes invité, cliquez sur **[!UICONTROL OK]**.

Le statut de l’envoi passe à `Canceled`. Si le transporteur ne prend pas en charge les annulations, un message d&#39;erreur s&#39;affiche et explique pourquoi l&#39;envoi n&#39;a pas pu être annulé.
...
| [!UICONTROL Action] | ![Icône de la corbeille](../assets/icon-delete-trashcan-solid.png) - Supprime les informations du package de l’enregistrement de l’expédition. |
