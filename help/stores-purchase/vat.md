...
description: Découvrez comment Adobe Commerce calcule la taxe sur la valeur ajoutée (TVA) à l’aide des règles d’adresse du commerçant ou du client et comment appliquer différents taux de TVA par produit ou service.
...
|--- |--- |
| Classe de taxe client | Les classes de taxe client doivent inclure : <br />Une classe pour les clients domestiques. <br />Classe pour les clients dont les ID TVA sont incorrectement formatés.<br />Classe pour les clients dont la validation des ID TVA a échoué. |
