...
1. Pour permettre à d’autres personnes d’afficher leur liste de souhaits, sélectionne la variable **[!UICONTROL Public Wish List]** .

   >[!NOTE]
   >
   >La principale différence entre `Public` et `Private` Les listes de souhaits privées ne sont pas [searchable](wishlist-configuration.md#add-wish-list-search) par le biais de listes de souhaits.
...
1. Le client clique sur la flèche située en regard de l’objet _Ajouter à la liste des souhaits_ et sélectionne la variable **[!UICONTROL Create New Wish List]**.
...
1. Cliquez sur la flèche en regard de **[!UICONTROL Add to Wish List]** et choisit **[!UICONTROL Create New Wish List]**.

1. entre dans la variable **[!UICONTROL Wish List Name]**.
...
1. Le client ouvre la **[!UICONTROL Shopping Cart]** page.

1. Sous l’élément , cliquez sur la flèche en regard de **[!UICONTROL Move to Wishlist]** et choisit **[!UICONTROL Create New Wish List]**.
...
1. Pour ajouter une **[!UICONTROL Comment]** sur le produit, renseigne le texte dans la zone située sous le prix.

   ![Options de modification](./assets/account-dashboard-wishlist-edit-options.png){width="700" zoomable="yes"}

1. Pour modifier la sélection des options de produit, cliquez sur **[!UICONTROL Edit]** et effectue les opérations suivantes :
...
1. Met à jour la variable **[!UICONTROL Qty]** et modifiez les autres options selon les besoins.

1. Clics **[!UICONTROL Add to Cart]**.

## Partager la liste des souhaits

1. Le client clique **[!UICONTROL Share Wishlist]**.
...
1. Clics **[!UICONTROL Share Wish List]**.
   ...
   ![Partager votre liste de souhaits](./assets/account-dashboard-wishlist-sharing.png){width="700" zoomable="yes"}

   Le message est envoyé depuis votre instance principale [contact de magasin](../getting-started/store-details.md#store-email-addresses) et comprend une miniature de chaque produit, avec des liens vers votre boutique.

   ![Email de liste de souhaits partagés](./assets/account-dashboard-wishlist-sharing-email.png){width="500" zoomable="yes"}
...
1. Clics **[!UICONTROL Move Selected to Wish List]** et effectue l’une des opérations suivantes :
...
1. Clics **[!UICONTROL Copy Selected to Wish List]** et effectue l’une des opérations suivantes :
...
1. Passez la souris sur l’élément et accède à la **[!UICONTROL Qty]** qu’ils veulent ajouter au panier.

1. Clics **[!UICONTROL Add to Cart]**.

## Trouver une liste de souhaits client

Si la variable [Widget de recherche par liste de souhaits](wishlist-configuration.md#add-wish-list-search) dans inclus dans vos pages de magasin, les clients peuvent effectuer une recherche par nom ou adresse électronique du propriétaire de la liste de souhaits.

1. Dans le widget de recherche de la liste de souhaits, le client sélectionne une option de recherche.

1. Entrez le nom ou l’adresse électronique du propriétaire de la liste de souhaits et les clics **[!UICONTROL Search]**.

   La variable _Recherche dans la liste de souhaits_ les ouvertures de page et les listes noires correspondantes sont affichées dans la section des résultats de recherche.
