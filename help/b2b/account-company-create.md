...
1. Lors de la création initiale de l’entreprise, la grille _[!UICONTROL Company Hierarchy]_&#x200B;est vide lorsque vous la développez. Après avoir enregistré la société, vous pouvez l’inclure dans une hiérarchie de société. Voir [Gestion des entreprises](manage-companies.md).
