---
title: Guides de l’utilisateur de l’administrateur d’Adobe Commerce
description: Parcourir la documentation du produit Adobe Commerce
seo-title: Services for Adobe Commerce
seo-description: Documentation and resources for Adobe Commerce and Magento Open Source users working in the Admin.
breadcrumb-title: Guides d’utilisation de l’administrateur
...
Bienvenue dans la nouvelle génération de la première plateforme de commerce numérique au monde. Adobe Commerce offre aux commerçants en ligne une flexibilité et un contrôle inégalés sur l’apparence, le contenu et les fonctionnalités de leurs boutiques en ligne. L’administrateur dispose de puissants outils de marketing, d’optimisation des moteurs de recherche et de gestion de produits qui vous permettent de créer des sites adaptés aux besoins uniques de votre entreprise.

Les informations contenues dans les guides d’utilisation de l’administrateur sont conçues pour s’adapter aux utilisateurs professionnels travaillant dans Adobe Admin Commerce ou la base de code Magento Open Source. Il existe des notations pour les caractéristiques et fonctions exclusives à Adobe Commerce ou à un ensemble de fonctionnalités étendu.

## Adobe Commerce {#product-editions}

Adobe Commerce est une plateforme de commerce B2B et B2C agile qui permet aux commerçants et aux marques d’accélérer leurs revenus grâce à des expériences de commerce numérique centrées sur le client dans les espaces en ligne et physiques. Il s’agit du premier choix pour les moyennes et grandes entreprises, car il offre les modèles de déploiement les plus flexibles, du On-Premise au Cloud géré, avec des SLA garantis. Adobe Commerce permet des intégrations API-first et des extensions entièrement personnalisables, ainsi que l&#39;ensemble le plus riche de fonctionnalités d&#39;expérience commerciale de niveau entreprise, du marketing au merchandising et à l&#39;exécution. Adobe Commerce repose sur un code source ouvert afin d’offrir flexibilité et extensibilité comme aucune autre plateforme commerciale.
...
<tr>
   ...
   <td valign="top">
   <a href="../getting-started/guide-overview.md"><strong>Prise en main</strong></a>
    <div>
...
<tr>
  <td valign="top">
   ...
   <td valign="top"><a href="../b2b/guide-overview.md"><strong>Adobe Commerce B2B</strong></a> [ ! PaaS BADGE uniquement]{type=Informative url="https://experienceleague.adobe.com/en/docs/commerce/user-guides/product-solutions » tooltip="S’applique aux projets Adobe Commerce on Cloud (infrastructure PaaS gérée par Adobe) et aux projets locaux uniquement."}
...
<tr>
  <td valign="top">
   ...
   <td valign="top"><a href="../catalog/guide-overview.md"><strong>Gestion de catalogue</strong></a>
...
<tr>
    <td valign="top">
       <img alt="Gestion du stock" src="./assets/icon-transfer.svg" width="40" height="40"/></td>
   <td valign="top"><a href="../inventory-management/guide-overview.md"> <strong>[!DNL Inventory Management]</strong></a>
    <div><em>Les [!DNL Inventory Management] fonctionnalités permettent aux commerçants disposant d’un seul magasin d’accéder à plusieurs entrepôts, magasins, points de ramassage, expéditeurs directs, etc. Utilisez ces fonctionnalités pour maintenir les quantités pour les ventes et gérer les expéditions pour compléter les commandes. </em></div>
  </td>
</tr>
<tr>
    <td valign="top">
       <img alt="Marchandisage et promotions" src="./assets/icon-labels.svg" width="40" height="40"/></td>
   <td valign="top"><a href="../merchandising-promotions/guide-overview.md"><strong>Marchandisage et promotions</strong></a>
    <div><em>Créez des promotions ciblées et des opportunités d’engagement client qui transforment les acheteurs en acheteurs. Gérer les relations avec les clients en soutenant les activités post-achat et en offrant des remises spéciales aux clients qui reviennent. Découvrez les bonnes pratiques et techniques qui soutiennent vos initiatives d’optimisation du moteur de recherche.</em></div>
  </td>
</tr>
<tr>
    <td valign="top">
       <img alt="Contenu et conception" src="./assets/icon-color-wheel.svg" width="40" height="40"/></td>
   <td valign="top"><a href="../content-design/guide-overview.md"> <strong>Contenu et conception</strong></a>
...
<tr>
   ...
   <td valign="top"><a href="../customers/guide-overview.md"> <strong>Gestion client</strong></a>
...
<tr>
    <td valign="top">
       <img alt="Boutiques et expérience d’achat" src="./assets/icon-shopping-cart.svg" width="40" height="40"/></td>
   <td valign="top"><a href="../stores-purchase/guide-overview.md"><strong>Boutiques et expérience d’achat</strong></a>
    <div><em>Le panier est positionné à la fin du chemin d’achat, à l’intersection de l’achat et de l’abandon. Configurez le point de vente et les fonctions de support qui transforment les articles du panier en commandes terminées.</em></div>
  </td>
</tr>
<tr>
    <td valign="top">
...
<tr>
   ...
   <td valign="top"><a href="../configuration-reference/guide-overview.md"> <strong>Référence de configuration</strong></a>
