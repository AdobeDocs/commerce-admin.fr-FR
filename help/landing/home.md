...
<tr>
  <td valign="top">
   ...
   <td valign="top"><a href="https://experienceleague.adobe.com/docs/commerce-admin/b2b/guide-overview.html?lang=fr"><strong>Adobe Commerce B2B</strong></a>
...
<tr>
   ...
   <td valign="top"><a href="https://experienceleague.adobe.com/docs/commerce-admin/page-builder/guide-overview.html?lang=fr"> <strong>[!DNL Page Builder]</strong></a>
...
## Nouveautés des guides de l’utilisateur des administrateurs

>[!TIP]
>
>Vous pouvez également consulter [Nouveautés de la documentation des services Commerce](https://experienceleague.adobe.com/docs/commerce/user-guides/home.html?lang=fr#what%E2%80%99s-new) et [Nouveautés des guides opérationnels](https://experienceleague.adobe.com/docs/commerce-operations/operational-guides/home.html?lang=fr#what%E2%80%99s-new).

| Description | Type | Date |
| ----------- | ---- | ---- |
| **Version B2B 1.4.0** - Les notes de mise à jour B2B d’Adobe Commerce décrivent les modifications et ajouts apportés par la version [1.4.0](../b2b/release-notes.md#b2b-v140). | Mise à jour | 06/13/23 |
| Version B2B **1.4.0** - La rubrique [Lancer le devis pour un acheteur](../b2b/sales-rep-initiates-quote.md) est désormais incluse dans le _Guide B2B d’Adobe Commerce_. Il décrit comment un vendeur peut créer un devis pour un acheteur spécifique afin de lancer le processus de négociation. | Nouveau | 06/13/23 |
| Version B2B **1.4.0** - Les rubriques [Négocier un devis](../b2b/quote-price-negotiation.md), [Devis négociables](../b2b/quotes.md) et [Activer les fonctionnalités B2B](../b2b/enable-basic-features.md) sont mises à jour pour refléter les modifications apportées aux devis initiés par le vendeur et aux fonctionnalités par défaut. | Mise à jour | 06/13/23 |
| **Version 2.2.0 de l’intégration Adobe IMS** - La rubrique [ Désactiver l’intégration d’administration Commerce avec Adobe ID ](../getting-started/adobe-ims-disable.md) est désormais incluse dans le _Guide de prise en main_. Elle décrit une procédure facultative pour désactiver l’intégration d’administration d’Adobe Commerce avec Adobe IMS. | Nouveau | 06/13/23 |
| **Version 2.2.0 de l’intégration Adobe IMS** - Modifications de la présentation de l’intégration [Adobe Identity Management Service (IMS)](../getting-started/adobe-ims-integration-overview.md) et des rubriques [ Configurer l’intégration Commerce Admin avec Adobe ID ](../getting-started/adobe-ims-config.md) pour refléter les fonctionnalités mises à jour. | Mise à jour | 06/13/23 |
| **[!DNL Audience Activation]** - Des informations nouvelles, mises à jour et améliorées sont incluses dans la rubrique [[!DNL Audience Activation]](../customers/audience-activation.md) pour refléter l’interface utilisateur de configuration [!DNL Experience Platform Connector] et comment utiliser une instance Commerce découplée avec des règles de prix de panier et des blocs dynamiques. | Mise à jour | 06/13/23 |
| **Obsolescence de l’API UPS** - Mise à jour de la rubrique [United Parcel Service (UPS)](../stores-purchase/ups.md) et de la page de référence de configuration [Méthodes de diffusion](../configuration-reference/sales/delivery-methods.md#ups) pour refléter l’obsolescence temporaire des API UPS pour générer de nouvelles clés API. | Mise à jour | 06/08/23 |
| Version **2.4.6** - Mise à jour des rubriques [Liste de produits](../catalog/products-list.md) et [Référence de configuration d’administration](../configuration-reference/advanced/admin.md) afin d’inclure des informations sur les limites d’affichage des produits qui peuvent être utilisées pour améliorer les performances des catalogues volumineux. | Mise à jour | 03/14/23 |
| Version **2.4.6** - Mise à jour des rubriques [Créer et supprimer des segments clients](../customers/customer-segment-create.md) et [Référence de configuration client](../configuration-reference/customers/customer-configuration.md) afin d’inclure des informations sur la validation en temps réel des segments. | Mise à jour | 03/14/23 |
| Version **2.4.6** - Mise à jour des rubriques [Braintree](../stores-purchase/braintree.md) et [Référence de configuration Braintree](../configuration-reference/sales/braintree.md) afin de refléter les nouvelles options de paiement et les options mises à jour prises en charge par l’intégration Braintree groupée. | Mise à jour | 03/14/23 |
| Version **2.4.6** - Mise à jour des rubriques [Configuration de la devise](../stores-purchase/currency-configuration.md) et [Configuration de la devise](../configuration-reference/general/currency-setup.md) pour inclure la nouvelle option [!DNL Fixer API] (APILayer). | Mise à jour | 03/14/23 |
| Version **2.4.6** - Mise à jour des rubriques [Configurer les communications par e-mail](../systems/email-communications.md) et [Référence de configuration du système](../configuration-reference/advanced/system.md#uicontrol-mail-sending-settings) pour inclure la nouvelle option SMTP pour les communications par e-mail. | Mise à jour | 03/14/23 |
| **Version 2.4.6** - Mise à jour des [Notes de mise à jour d’Inventory management](../inventory-management/release-notes.md) avec une liste descriptive des correctifs inclus dans la dernière version d’extension groupée (v1.2.6). | Mise à jour | 03/14/23 |
| **Version 2.4.6** - Mise à jour des notes de mise à jour [B2B](../b2b/release-notes.md) avec une liste descriptive des correctifs inclus dans la dernière version de l’extension (v1.3.5). | Mise à jour | 03/14/23 |
| **Nouvelle rubrique** - Ajout de la rubrique [Activation des audiences](../getting-started/commerce-account-transfer.md) au _Guide de gestion des clients_, qui fournit des informations détaillées sur l’activation des audiences Real-Time CDP dans Adobe Commerce. | Nouveau | 03/13/23 |
