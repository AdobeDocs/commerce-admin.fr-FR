...
<table>
  ...
  <tr>
    ...
    <td>bibliothèque</td>
    <td>AWS SDK pour PHP - Utilisez Amazon services Web dans votre projet PHP</td>
  </tr>
  <tr>
    <td>
...
<table>
  ...
  <tr>
    ...
    <td>bibliothèque</td>
    <td>Une simple bibliothèque pour coder et décoder les jetons web JSON (JWT) en PHP. Doit être conforme aux spécifications actuelles.</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>bibliothèque</td>
    <td>Extensions de l’API PHP Reflection, de la numérisation de code statique et de la génération de code</td>
  </tr>
  <tr>
    <td>
...
<table>
  ...
  <tr>
    <td>
      <a href="https://github.com/Seldaek/signal-handler.git">seld/gestionnaire de signaux</a>
    </td>
    <td>bibliothèque</td>
  ...
  <tr>
    ...
    <td>bibliothèque</td>
    <td>Fournit des outils qui permettent aux composants de votre application de communiquer entre eux en répartissant des événements et en les écoutant</td>
  </tr>
  <tr>
    <td>
    ...
    <td>bibliothèque</td>
    <td>Abstractions génériques relatives à la répartition des événements</td>
  </tr>
  <tr>
    <td>
      <a href="https://github.com/symfony/filesystem.git">symfony/système de fichiers</a>
    </td>
    <td>bibliothèque</td>
  ...
  <tr>
    ...
    <td>bibliothèque</td>
    <td>Abstractions génériques relatives aux clients HTTP</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>bibliothèque</td>
    <td>Symfony polyfill backporter certaines fonctionnalités PHP 7.3+ vers des versions PHP inférieures</td>
  </tr>
  <tr>
    <td>
