---
title: Media - Video
description: Découvrez le type de contenu vidéo utilisé pour ajouter une vidéo hébergée sur YouTube ou Vimeo au [!DNL Page Builder] scène.
...
Utilisez la variable _Vidéo_ type de contenu pour ajouter une vidéo hébergée sur [YouTube][1] ou [Vimeo][2] à la fonction [[!DNL Page Builder] étape](workspace.md#stage). Il est facile d’incorporer des vidéos dans une page ou un bloc ou dans des descriptions de produits et de catégories.
...
| Paramètres | ![Icône Paramètres](./assets/pb-icon-settings.png){width="25"} | Ouvre la _[!UICONTROL Edit Video]_dans laquelle vous pouvez modifier les propriétés de la vidéo et du conteneur. |
...
| Supprimer | ![Icône Supprimer](./assets/pb-icon-remove.png){width="25"} | Supprime la vidéo de la scène. |
...
1. Avant de commencer, accédez au [YouTube][1] ou [Vimeo][2] vidéo à incorporer et copiez le lien.

   Vous pouvez également copier un lien direct vers un fichier vidéo valide. Voir [Paramètres vidéo de base](#basic-video-settings) pour les liens valides.

1. Dans le [!DNL Commerce] Admin, revenez au [!DNL Page Builder] espace de travail dans lequel vous souhaitez ajouter la vidéo.

1. Dans le [!DNL Page Builder] panneau, développer **[!UICONTROL Media]** et faites glisser un **[!UICONTROL Video]** espace réservé sur la scène.

   ![Glissement d’un espace réservé de vidéo vers la scène](./assets/pb-media-video-drag.png){width="600" zoomable="yes"}

1. Passez la souris sur le conteneur vidéo pour afficher la boîte à outils et sélectionnez l’option _Paramètres_ ( ![Icône Paramètres](./assets/pb-icon-settings.png){width="20"} ).

1. Pour **[!UICONTROL Video URL]**, collez l’URL de la vidéo que vous avez copiée.

   L’URL de la variable [!DNL Page Builder] La vidéo utilisée dans cet exemple est : `https://www.youtube.com/watch?v=Y0KNS7C5dZA`.

1. Pour limiter la variable **[!UICONTROL Maximum Width]** de la vidéo, saisissez la largeur maximale en pixels.
...
1. Pour modifier la vidéo active, mettez à jour la variable **[!UICONTROL Video URL]**.
...
1. Pour démarrer automatiquement la vidéo une fois la page chargée, définissez **[!UICONTROL Autoplay]** to `Yes`.
   ...
   - [Stratégie de lecture automatique depuis Google (Chrome/YouTube)](https://developer.chrome.com/blog/autoplay/)
...
- Définissez la variable **[!UICONTROL Border]** style appliqué aux quatre côtés du conteneur vidéo :
...
- (Facultatif) Indiquez les noms des **[!UICONTROL CSS classes]** de la feuille de style actuelle à appliquer au conteneur vidéo.

  Séparez plusieurs noms de classe par un espace.

- Saisissez des valeurs, en pixels, pour la variable **[!UICONTROL Margins and Padding]** pour spécifier les marges extérieures et la marge intérieure du conteneur vidéo.
...
1. Passez la souris sur le conteneur vidéo pour afficher la boîte à outils et sélectionnez l’option _Déplacer_ ( ![Icône Déplacer](./assets/pb-icon-move.png){width="20"} ).
...
1. Passez la souris sur le conteneur vidéo pour afficher la boîte à outils et sélectionnez l’option _Supprimer_ (![Icône Supprimer](./assets/pb-icon-remove.png)).
