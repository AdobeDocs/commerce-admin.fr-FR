...
description: Découvrez comment utiliser la page Notifications pour passer en revue les messages concernant les opérations du système.
...
La page _Notifications_ répertorie tous les messages classés par gravité, le plus récent en haut. Les commandes Action peuvent être utilisées pour marquer des messages individuels comme lus, afficher des informations plus détaillées ou supprimer le message de la boîte de réception.

1. Effectuez l’une des opérations suivantes pour ouvrir la page _[!UICONTROL Notifications]_:
