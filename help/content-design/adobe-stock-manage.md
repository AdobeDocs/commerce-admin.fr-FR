...
1. Cliquez sur **[!UICONTROL Sign In]** en haut à droite.
   ...
   Une nouvelle fenêtre de navigateur vous guide tout au long du processus de connexion à [&#128279;](https://helpx.adobe.com/fr/manage-account/using/access-adobe-id-account.html).
