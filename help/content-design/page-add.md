...
description: Découvrez comment ajouter et supprimer des pages de contenu utilisées dans votre [!DNL Commerce] magasin.
...
1. Si vous ne souhaitez pas publier la page immédiatement, définissez **[!UICONTROL Enable Page]** to `No`.

1. Saisissez le **[!UICONTROL Page Title]**.

   Le titre de la page apparaît dans la variable [chemin de navigation](../catalog/navigation-breadcrumb-trail.md) navigation.

### Etape 2 : compléter le contenu

Selon votre [Configuration des outils de contenu avancés](../configuration-reference/general/content-management.md), ajoutez le contenu de la page.
...
1. Dans le **[!UICONTROL Content Heading]** , saisissez l’en-tête que vous souhaitez afficher en haut de la page.

   Si cette option est activée, la variable [Page Builder](../page-builder/introduction.md) l’étape et le panneau apparaissent sous l’en-tête Contenu. Pour plus d’informations, voir [Workspace](../page-builder/workspace.md). If _Page Builder_ n’est pas activé, l’éditeur s’ouvre en mode WYSIWYG avec la barre d’outils supérieure.
...
1. Complétez le contenu et formatez le texte selon vos besoins.
   ...
   Vous pouvez ajouter [images](media-storage.md), [variables](../systems/variables-predefined.md), et [widgets](widgets.md) selon les besoins. Pour plus d’informations, voir [Utilisation de l’éditeur](editor.md).

### Étape 3 : renseigner les informations d’optimisation pour les moteurs de recherche

1. Développer ![Sélecteur d’extension](../assets/icon-display-expand.png) **[!UICONTROL Search Engine Optimization]**.

   ![Optimisation du moteur de recherche](./assets/page-search-engine-optimization.png){width="600" zoomable="yes"}

1. Acceptez la valeur par défaut ou saisissez une autre valeur **[!UICONTROL URL Key]** qui se compose de tous les caractères minuscules, avec des tirets au lieu d’espaces.
...
1. Saisissez votre choix de valeur élevée. **[!UICONTROL Meta Keywords]** que les moteurs de recherche peuvent utiliser pour indexer la page.
...
1. Pour **[!UICONTROL Meta Description]**, saisissez une brève description de la page pour les listes de résultats de recherche.
...
1. Développer ![Sélecteur d’extension](../assets/icon-display-expand.png) **[!UICONTROL Page in Websites]**.

   ![Pages des sites web](./assets/page-in-websites.png){width="600" zoomable="yes"}

1. Dans le **[!UICONTROL Store View]** sélectionnez chaque vue dans laquelle la page doit être disponible.
...
1. Développer ![Sélecteur d’extension](../assets/icon-display-expand.png) **[!UICONTROL Hierarchy]**.

   ![Hiérarchie](./assets/page-hierarchy.png){width="600" zoomable="yes"}

1. Si cette page est enfant d’une autre page, cochez la case de la variable **[!UICONTROL Parent page]**.
...
1. Pour modifier la disposition des colonnes de la page, définissez **[!UICONTROL Layout]** à l’une des options suivantes :
...
1. Pour modifier le thème de la page, définissez **[!UICONTROL New Theme]** à l’une des options suivantes :
...
1. ![Magento Open Source](../assets/open-source.svg) (Magento Open Source uniquement) Pour planifier une modification de conception, développez ![Sélecteur d’extension](../assets/icon-display-expand.png) **[!UICONTROL Custom Design Update]** et procédez comme suit :
   ...
   - Utilisez le calendrier (![Icône Calendrier](../assets/icon-calendar.png)) pour choisir la variable **[!UICONTROL From]** et **[!UICONTROL To]** dates de prise d’effet de la modification.

   - Pour appliquer un thème différent à la page, sélectionnez le nom du **[!UICONTROL New Theme]**.

   - Pour modifier la mise en page des colonnes, choisissez la variable **[!UICONTROL Layout]** que vous souhaitez postuler.

### Étape 7 : aperçu de la page

1. Cliquez sur le bouton **[!UICONTROL Save]** flèche et choisissez **[!UICONTROL Save & Close]** pour revenir à la grille Pages .

1. Recherchez la page dans la grille et sélectionnez **[!UICONTROL View]** dans le _[!UICONTROL Action]_colonne .
...
1. Sélectionner **[!UICONTROL Edit]** dans le _[!UICONTROL Action]_de la grille.

1. Définir **[!UICONTROL Enable Page]** to `Yes`.

1. Cliquez sur le bouton **[!UICONTROL Save]** flèche et choisissez **[!UICONTROL Save & Close]**.
...
1. Dans la grille, recherchez la page à dupliquer, puis cliquez sur **[!UICONTROL Edit]** dans le _[!UICONTROL Action]_colonne .

1. Cliquez sur le bouton **[!UICONTROL Save]** flèche et choisissez **[!UICONTROL Save & Duplicate]**.

1. Lorsque les messages que la page a été enregistrée et dupliquée s’affichent, cliquez sur **[!UICONTROL Back]** dans la barre de boutons supérieure pour revenir à la grille.
...
1. Ouvrez la page en double dans _Modifier_ et procédez comme suit :

   - Si vous souhaitez publier la page immédiatement, définissez **[!UICONTROL Enable Page]** to `Yes`.

   - Mettez à jour le **[!UICONTROL Page Title]**, selon les besoins.

   - Développer ![Sélecteur d’extension](../assets/icon-display-expand.png) la valeur **[!UICONTROL Search Engine Optimization]** et saisissez l’unique **[!UICONTROL URL Key]** que vous souhaitez utiliser pour la page dupliquée.
...
Il existe deux manières de supprimer une page créée. Vous pouvez la supprimer de la _[!UICONTROL Pages]_ou à partir de_[!UICONTROL Edit]_ page.
...
1. Dans le _[!UICONTROL Actions]_pour l’entité de page, cliquez sur **[!UICONTROL Select]**et choisissez **[!UICONTROL Edit]**.
