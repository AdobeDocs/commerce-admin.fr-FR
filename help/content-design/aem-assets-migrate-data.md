...
| barrage:status | Statut d’approbation de la ressource dans AEM Assets | `approved` |
...
| commerce:skus | SKU de produit associés à cette ressource | Valeur de chaîne (par exemple, `sample1`) |
