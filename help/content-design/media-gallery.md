...
>[!NOTE]
>
>Les images de produit ajoutées à la section de produit ](../catalog/product-image.md#upload-an-image) ne sont pas gérées par le [!DNL Media Gallery]. [_[!UICONTROL Images and Videos]_Seules les images utilisées dans les champs de la section Produit_[!UICONTROL Content]_ sont affichées et filtrées dans la nouvelle [!DNL Media Gallery].
