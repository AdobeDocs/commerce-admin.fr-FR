...
Avec Adobe Commerce ou Magento Open Source 2.4, les commerçants peuvent utiliser le nouveau __ amélioré[!DNL Media Gallery] pour organiser et gérer leurs fichiers multimédias sur le serveur. Cette nouvelle [!DNL Media Gallery] contient les mêmes fonctionnalités que le stockage multimédia existant, mais comprend une interface utilisateur améliorée et une intégration plus étroite avec [Adobe Stock](https://stock.adobe.com).
...
>[!VIDEO](https://video.tv.adobe.com/v/3411044?captions=fre_fr&quality=12&learn=on)
