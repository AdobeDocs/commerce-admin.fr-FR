...
Pour plus d’informations sur le choix entre les redirections à terme de recherche, les réécritures d’URL, les règles de [!DNL Live Search] et le routage storefront, voir [Redirections à terme de recherche et routage storefront](search-term-redirects.md).
