---
title: Expérience de storefront du registre des cadeaux
...
![Exemple de storefront - informations sur le registre des cadeaux](./assets/gift-registry-create-baby-storefront.png){width="700" zoomable="yes"}
...
1. Dans le tableau de bord de son compte, le client accède à **[!UICONTROL Gift Registry]**.
   ...
   ![Gestion des articles du registre des cadeaux](./assets/account-dashboard-gift-registry-items-management.png){width="700" zoomable="yes"}
