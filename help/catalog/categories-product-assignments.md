...
>[!NOTE]
>
>Dans les pages de catégories, les produits `Out of stock` sont toujours affichés **_après_** `In Stock` les produits de la liste des produits avec tous les types de tri.
