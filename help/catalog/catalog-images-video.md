---
title: Images et vidéo du catalogue
description: Découvrez comment utiliser les médias numériques pour améliorer les pages de produits de votre catalogue et fournir des visuels à vos clients.
...
![Explorateur de médias Storefront](./assets/storefront-thumbnail-gallery.png){width="700" zoomable="yes"}
...
![Zoom de l’image](./assets/storefront-image-zoom.png){width="700" zoomable="yes"}

### Boîtes de lumière et curseurs

Il existe de nombreuses zones lumineuses et curseurs tiers que vous pouvez utiliser pour améliorer la présentation de vos images de produit. Recherchez des extensions dans [&#128279;](../getting-started/commerce-marketplace.md).
