...
description: Découvrez comment utiliser les paramètres de [!UICONTROL Search Engine Optimization] pour définir la clé URL et les champs de métadonnées utilisés par les moteurs de recherche pour indexer la catégorie.
