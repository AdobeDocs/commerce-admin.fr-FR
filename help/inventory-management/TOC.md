...
user-guide-description: Découvrez comment utiliser  [!DNL Inventory Management]  gérer les stocks, les sources et les quantités, configurer les paramètres dans l’interface d’administration ou de ligne de commande et gérer les commandes et les expéditions pour votre  [!DNL Commerce] .
...
- Concepts de base des stocks {#basics}
...
- Configuration {#configuration}
  ...
  - Alertes de produits {#product-alerts}
