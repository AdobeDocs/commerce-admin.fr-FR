...
description: Importez et exportez  [!DNL Inventory Management]  affectations source et des quantités par source par SKU à l’aide d’outils de transfert de données de catalogue natifs.
