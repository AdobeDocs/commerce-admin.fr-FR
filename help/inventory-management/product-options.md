...
description: Configurez des options d'inventaire avancé par produit [!DNL Inventory Management] et qui remplacent les paramètres globaux de stock et de source.
