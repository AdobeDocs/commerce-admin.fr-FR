...
description: Découvrez comment la facturation, l’expédition, les annulations et les remboursements mettent à jour [!DNL Inventory Management] réservations et les quantités en stock par source.
