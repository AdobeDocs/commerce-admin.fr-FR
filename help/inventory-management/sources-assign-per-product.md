...
description: Attribuez une ou plusieurs sources  [!DNL Inventory Management]  un produit dans l’Administration avant de définir des quantités et des seuils par source.
